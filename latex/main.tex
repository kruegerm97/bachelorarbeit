...
\lstinputlisting[language=Python, caption={Manuelles Skript Testfall 2}, label={lst:manualscript1}]{../testcases/testcase2/myscript.py}
\lstinputlisting[language=Python, caption={Manuelles Skript Testfall 3}, label={lst:manualscript1}]{../testcases/testcase3/myscript.py}
\lstinputlisting[language=Python, caption={Manuelles Skript Testfall 4}, label={lst:manualscript1}]{../testcases/testcase4/myscript.py}
