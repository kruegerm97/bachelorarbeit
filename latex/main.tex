...
\begin{itemize}
    ...
    \item Fünf Skripte (\#3, \#7, \#8, \#9, \#10) schlugen aufgrund von \enquote{KeyError}-Fehlermeldungen fehl, da der generierte Code nicht exakt mit den vorhandenen Spaltennamen übereinstimmte.
\end{itemize}
...
\subsubsection{Testfall 1}
\lstinputlisting[language=Python, caption={OpenAI API Request Skript Testfall 1}, label={lst:request1}]{../testcases/testcase1/request.py}
\lstinputlisting[language=Python, caption={Generierter Python Code Testfall 1, Ausführung 1}, label={lst:code1_1}]{../testcases/testcase1/exec1/script.py}
\lstinputlisting[language=Python, caption={Generierter Python Code Testfall 1, Ausführung 2}, label={lst:code1_2}]{../testcases/testcase1/exec2/script.py}
\lstinputlisting[language=Python, caption={Generierter Python Code Testfall 1, Ausführung 3}, label={lst:code1_3}]{../testcases/testcase1/exec3/script.py}
\lstinputlisting[language=Python, caption={Generierter Python Code Testfall 1, Ausführung 4}, label={lst:code1_4}]{../testcases/testcase1/exec4/script.py}
\lstinputlisting[language=Python, caption={Generierter Python Code Testfall 1, Ausführung 5}, label={lst:code1_5}]{../testcases/testcase1/exec5/script.py}
\lstinputlisting[language=Python, caption={Generierter Python Code Testfall 1, Ausführung 6}, label={lst:code1_6}]{../testcases/testcase1/exec6/script.py}
\lstinputlisting[language=Python, caption={Generierter Python Code Testfall 1, Ausführung 7}, label={lst:code1_7}]{../testcases/testcase1/exec7/script.py}
\lstinputlisting[language=Python, caption={Generierter Python Code Testfall 1, Ausführung 8}, label={lst:code1_8}]{../testcases/testcase1/exec8/script.py}
\lstinputlisting[language=Python, caption={Generierter Python Code Testfall 1, Ausführung 9}, label={lst:code1_9}]{../testcases/testcase1/exec9/script.py}
\lstinputlisting[language=Python, caption={Generierter Python Code Testfall 1, Ausführung 10}, label={lst:code1_10}]{../testcases/testcase1/exec10/script.py}
