...
prompt = f"""
Ich habe eine Excel Datei mit dem Namen 'Fallzahlen&HZ 2014-2023.xlsx'. Erstelle mir ein Python Skript, das die Daten des Sheets 'Fallzahlen_2023' ausliest und für jeden Oberbezirk den Unterbezirk mit den meisten Raubdelikten ausgibt.
